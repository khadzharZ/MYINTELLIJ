...
public class HW1 {
    ...
    public static void main(String[] args) {
        Car car = new Car("Progressive", "Honda");
        Pet pet = new Pet("Veti", "Dog");
        Health health = new Health("Helthy Blue");
...
class Car extends Insurance {
    ...
    @Override
    String getQuote() {
        return "Getting a car insurance quote  " + insuranceName + "  for " + carModel;
    }
    @Override
    String cancelInsurance() {
        return "Canceling car insurance  " + insuranceName + "  for " + carModel;
    }
}
class Pet extends Insurance {
    ...
    @Override
    String getQuote() {
        return "Getting a pet insurance quote " + insuranceName + "  for " + petType;
    }
    @Override
    String cancelInsurance() {
        return "Canceling pet insurance  " + insuranceName + "  for " + petType;
    }
}
class Health extends Insurance {
    ...
    @Override
    String getQuote() {
        return "Getting a health insurance quote  " + insuranceName + " company";
    }
    @Override
    String cancelInsurance() {
        return "Canceling a health insurance  " + insuranceName + " company";
    }
}
