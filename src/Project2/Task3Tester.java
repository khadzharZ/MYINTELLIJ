...
public class Task3Tester {
    public static void main(String[] args) {
        Car Truck1 = new Truck(20000.0, "Light Blue",3000.0);
        System.out.println("Truck's color is Light Blue and the price is  " +Truck1.calculateSalePrice());

        Car Sedan1 = new Sedan(20000.0,"Burgundy", 30);
        System.out.println("Sedan's color is Burgundy and the price is  "+Sedan1.calculateSalePrice());
